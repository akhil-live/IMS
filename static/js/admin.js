...
var purchaseitemHeight = $('.purchase-list .item-list').outerHeight();
function slideNext(){
  $('.purchase-list').animate({
    marginTop: -purchaseitemHeight
  },500,function(){
    $(this).append($('.purchase-list .item-list:first'));
    $(this).css('margin-top',0);
  });
}

function slidePrev(){
  $('.purchase-list').prepend($('.purchase-list .item-list:last'));
  $('.purchase-list').css('margin-top',-purchaseitemHeight);
  $('.purchase-list').animate({
    marginTop:0
  },500);
}

$('#purchaseNext').click(slideNext);
$('#purchasePrev').click(slidePrev);

setInterval(slideNext,3000);

var todayitemHeight = $('.today-summary-list .item-list').outerHeight();
function todayslideNext(){
  $('.today-summary-list').animate({
    marginTop: -todayitemHeight
  },500,function(){
    $(this).append($('.today-summary-list .item-list:first'));
    $(this).css('margin-top',0);
  });
}

function todayslidePrev(){
  $('.today-summary-list').prepend($('.today-summary-list .item-list:last'));
  $('.today-summary-list').css('margin-top',-todayitemHeight);
  $('.today-summary-list').animate({
    marginTop:0
  },500);
}

$('#todaySummaryNext').click(todayslideNext);
$('#todaySummaryPrev').click(todayslidePrev);

setInterval(todayslideNext,4000);

var monthitemHeight = $('.low-stock-list .item-list').outerHeight();
function monthslideNext(){
  $('.low-stock-list').animate({
    marginTop: -monthitemHeight
  },500,function(){
    $(this).append($('.low-stock-list .item-list:first'));
    $(this).css('margin-top',0);
  });
}

function monthslidePrev(){
  $('.low-stock-list').prepend($('.low-stock-list .item-list:last'));
  $('.low-stock-list').css('margin-top',-monthitemHeight);
  $('.low-stock-list').animate({
    marginTop:0
  },500);
}

$('#lowStockNext').click(monthslideNext);
$('#lowStockPrev').click(monthslidePrev);
